...
namespace Joeku.SR
{
    public class SR_Utilities
    {
        ...
        public static void NewRuneAcc(SR_RuneAccount acc)
        {
            ...
            try
            {
                Console.WriteLine("Adding Felucca runes...");
                acc.AddRune(AddTree(Map.Felucca));

                Console.WriteLine("Adding Trammel runes...");
                acc.AddRune(AddTree(Map.Trammel));

                Console.WriteLine("Adding Ilshenar runes...");
                acc.AddRune(AddTree(Map.Ilshenar));

                Console.WriteLine("Adding Malas runes...");
                acc.AddRune(AddTree(Map.Malas));

                Console.WriteLine("Adding Tokuno runes...");
                acc.AddRune(AddTree(Map.Tokuno));

                Console.WriteLine("Adding TerMur runes...");
        ...
        private static SR_Rune AddTree(Map map)
        {
            ...
            try
            {
                ...
                Console.WriteLine($"Processing tree for map: {map}");
                Console.WriteLine($"Tree.Root: {(tree.Root != null ? "Initialized" : "Null")}");
                if (tree.Root != null)
                {
                    Console.WriteLine($"Tree.Root.Categories: {(tree.Root.Categories != null ? "Initialized" : "Null")}, Length: {tree.Root.Categories?.Length}");
                    Console.WriteLine($"Tree.Root.Locations: {(tree.Root.Locations != null ? "Initialized" : "Null")}, Length: {tree.Root.Locations?.Length}");
